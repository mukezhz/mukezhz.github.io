...
publishDate: 2022-04-21 10:07:00
img: /assets/devops/program.svg
img_alt: Program Image
...
## How Application Execute

This blog is for beginer who doesn't have any idea how software works. If you are starting your computer journey this might be helpful.

**What's the first thing we do if you want to run the firefox and it's not in your machine/computer/OS?**  
Ans: You just seach firefox and download the executable file and install it and run it.
...
- When we run the software,
  - the operating system analyzes the constrains to run the program (ie. necessary memory, CPU, GPU, dependencies) then
...
- Dependencies are needed for several reasons:
  ...
  - **Code Reusability:**
    ...
    - in case if you have done C you can think like this: to run the printf() after includeng stdio.h you don't need to implement the printf() logic
  - **Compatibility and Stability:**
    ...
    - n case if you have done C you can think like this: you can run printf() after including stdio.h you don't need to worry about version of C language
  - **Efficiency:**
